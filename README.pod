...
The C<WebService::Embedly> is a class implementation for querying the Embed.ly web service.  Prior to using this module you should go to L<http://embed.ly> and sign up for an api_key.
